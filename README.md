...
### We could also create a table to analyze how the length of time of the campaign affected the outcome. Using the launch date and end date of a campaign, we could calculate its duration. Then we could visualize this data with a stacked bar graph comparing the duration of the campaign to the campaign outcome.
